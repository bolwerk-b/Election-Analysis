...
- The winner of the election was:
  ...
  ## Summary
  This script will be able to assist in analyzing future elections by calculating the total number of votes, count of votes for each candidate, as well as the counties with the highest voter turnout.
